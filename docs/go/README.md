...
* Last Sync Time: Mon Nov 01 2021 14:18:57 GMT+0800 (中国标准时间)
...
| :---- | ----: | :---- | :---- |
| [oto](https://github.com/hajimehoshi/oto) | 879 | ♪ A low-level library to play sound on multiple platforms ♪ | 21 hours ago |
| [portaudio](https://github.com/gordonklaus/portaudio) | 473 | Go bindings for the PortAudio audio I/O library | a year ago |
| [music-theory](https://github.com/go-music-theory/music-theory) | 364 | Go models of Note, Scale, Chord and Key | a year ago |
...
| [id3v2](https://github.com/bogem/id3v2) | 194 | 🎵 ID3 decoding and encoding library for Go | 19 days ago |
...
| [GoAudio](https://github.com/DylanMeeus/GoAudio) | 157 | Go tools for audio processing & creation 🎶 | 7 months ago |
...
| [gaad](https://github.com/Comcast/gaad) | 88 | GAAD (Go Advanced Audio Decoder) | a month ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [casbin](https://github.com/casbin/casbin) | 10545 | An authorization library that supports access control models like ACL, RBAC, ABAC in Golang | 4 days ago |
| [oauth2](https://github.com/golang/oauth2) | 3881 | Go OAuth2 | 4 days ago |
| [goth](https://github.com/markbates/goth) | 3379 | Package goth provides a simple, clean, and idiomatic way to write authentication packages for Go web applications. | a day ago |
| [authboss](https://github.com/volatiletech/authboss) | 2874 | The boss of http auth. | 3 months ago |
| [go-jose](https://github.com/square/go-jose) | 1831 | An implementation of JOSE standards (JWE, JWS, JWT) in Go | 7 days ago |
| [loginsrv](https://github.com/tarent/loginsrv) | 1827 | JWT login microservice with plugable backends such as OAuth2, Google, Github, htpasswd, osiam, .. | 8 months ago |
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1825 | A standalone, specification-compliant,  OAuth2 server written in Golang. | 10 months ago |
| [osin](https://github.com/openshift/osin) | 1694 | Golang OAuth2 server library | 2 months ago |
| [gologin](https://github.com/dghubble/gologin) | 1449 | Go login handlers for authentication providers (OAuth1, OAuth2) | 3 days ago |
| [gorbac](https://github.com/mikespook/gorbac) | 1219 | goRBAC provides a lightweight role-based access control (RBAC) implementation in Golang. | 6 months ago |
| [scs](https://github.com/alexedwards/scs) | 954 | HTTP Session Management for Go | 5 days ago |
...
| [go-guardian](https://github.com/shaj13/go-guardian) | 314 | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication. | a month ago |
| [jwt](https://github.com/cristalhq/jwt) | 301 | Safe, simple and fast JSON Web Tokens for Go | 14 days ago |
| [jwt](https://github.com/pascaldekloe/jwt) | 270 | JSON Web Token library | 8 months ago |
