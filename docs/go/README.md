...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [oauth2](https://github.com/golang/oauth2) | 3639 | Go OAuth2 | 16 hours ago |
...
| [go-jose](https://github.com/square/go-jose) | 1758 | An implementation of JOSE standards (JWE, JWS, JWT) in Go | 20 days ago |
...
| [gologin](https://github.com/dghubble/gologin) | 1382 | Go login handlers for authentication providers (OAuth1, OAuth2) | 16 days ago |
