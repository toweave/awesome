...
* Last Sync Time: Fri May 21 2021 14:13:23 GMT+0800 (GMT+08:00)
...
| :---- | ----: | :---- | :---- |
| [oto](https://github.com/hajimehoshi/oto) | 810 | ♪ A low-level library to play sound on multiple platforms ♪ | 3 months ago |
| [portaudio](https://github.com/gordonklaus/portaudio) | 450 | Go bindings for the PortAudio audio I/O library | 8 months ago |
...
| [malgo](https://github.com/gen2brain/malgo) | 147 | Mini audio library | 14 days ago |
| [mix](https://github.com/go-mix/mix) | 139 | Sequence-based Go-native audio mixer for music apps | a year ago |
| [GoAudio](https://github.com/DylanMeeus/GoAudio) | 128 | Go tools for audio processing & creation 🎶 | 2 months ago |
| [gaad](https://github.com/Comcast/gaad) | 83 | GAAD (Go Advanced Audio Decoder) | 2 months ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [oauth2](https://github.com/golang/oauth2) | 3647 | Go OAuth2 | 3 days ago |
| [goth](https://github.com/markbates/goth) | 3169 | Package goth provides a simple, clean, and idiomatic way to write authentication packages for Go web applications. | a month ago |
| [authboss](https://github.com/volatiletech/authboss) | 2658 | The boss of http auth. | 3 days ago |
| [loginsrv](https://github.com/tarent/loginsrv) | 1779 | JWT login microservice with plugable backends such as OAuth2, Google, Github, htpasswd, osiam, .. | 3 months ago |
| [go-jose](https://github.com/square/go-jose) | 1761 | An implementation of JOSE standards (JWE, JWS, JWT) in Go | 25 days ago |
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1748 | A standalone, specification-compliant,  OAuth2 server written in Golang. | 5 months ago |
| [osin](https://github.com/openshift/osin) | 1669 | Golang OAuth2 server library | 3 months ago |
| [gologin](https://github.com/dghubble/gologin) | 1384 | Go login handlers for authentication providers (OAuth1, OAuth2) | 21 days ago |
| [gorbac](https://github.com/mikespook/gorbac) | 1170 | goRBAC provides a lightweight role-based access control (RBAC) implementation in Golang. | 15 days ago |
| [scs](https://github.com/alexedwards/scs) | 876 | HTTP Session Management for Go | a month ago |
| [paseto](https://github.com/o1egl/paseto) | 509 | Platform-Agnostic Security Tokens implementation in GO (Golang) | a year ago |
...
| [jwt](https://github.com/cristalhq/jwt) | 261 | Safe, simple and fast JSON Web Tokens for Go | a month ago |
| [go-guardian](https://github.com/shaj13/go-guardian) | 254 | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication. | a month ago |
...
| [httpauth](https://github.com/goji/httpauth) | 203 | HTTP Authentication middlewares | 9 months ago |
...
| [securecookie](https://github.com/chmike/securecookie) | 48 | Fast, secure and efficient secure cookie encoder/decoder  | 24 days ago |
...
| [casbin](https://github.com/hsluoyz/casbin) | 2 | An authorization library that supports access control models like ACL, RBAC, ABAC in Golang | a month ago |
