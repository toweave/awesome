...
* Last Sync Time: Tue May 18 2021 10:10:49 GMT+0800 (GMT+08:00)
...
| :---- | ----: | :---- | :---- |
| [oto](https://github.com/hajimehoshi/oto) | 808 | ♪ A low-level library to play sound on multiple platforms ♪ | 3 months ago |
...
| [id3v2](https://github.com/bogem/id3v2) | 189 | 🎵 ID3 decoding and encoding library for Go | a month ago |
...
| [malgo](https://github.com/gen2brain/malgo) | 145 | Mini audio library | 10 days ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [oauth2](https://github.com/golang/oauth2) | 3643 | Go OAuth2 | 8 hours ago |
| [goth](https://github.com/markbates/goth) | 3165 | Package goth provides a simple, clean, and idiomatic way to write authentication packages for Go web applications. | a month ago |
| [authboss](https://github.com/volatiletech/authboss) | 2655 | The boss of http auth. | 20 days ago |
...
| [go-jose](https://github.com/square/go-jose) | 1758 | An implementation of JOSE standards (JWE, JWS, JWT) in Go | 22 days ago |
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1748 | A standalone, specification-compliant,  OAuth2 server written in Golang. | 4 months ago |
| [osin](https://github.com/openshift/osin) | 1668 | Golang OAuth2 server library | 3 months ago |
| [gologin](https://github.com/dghubble/gologin) | 1383 | Go login handlers for authentication providers (OAuth1, OAuth2) | 18 days ago |
| [gorbac](https://github.com/mikespook/gorbac) | 1168 | goRBAC provides a lightweight role-based access control (RBAC) implementation in Golang. | 12 days ago |
...
| [permissions2](https://github.com/xyproto/permissions2) | 428 |   :closed_lock_with_key: Middleware for keeping track of users, login states and permissions | 9 months ago |
| [jwt](https://github.com/cristalhq/jwt) | 259 | Safe, simple and fast JSON Web Tokens for Go | 25 days ago |
| [go-guardian](https://github.com/shaj13/go-guardian) | 252 | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication. | 24 days ago |
...
| [sessionup](https://github.com/swithek/sessionup) | 111 | Straightforward HTTP session management | 2 months ago |
...
| [securecookie](https://github.com/chmike/securecookie) | 47 | Fast, secure and efficient secure cookie encoder/decoder  | 21 days ago |
