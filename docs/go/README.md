...
* Last Sync Time: Tue Jun 15 2021 10:16:59 GMT+0800 (GMT+08:00)
...
| :---- | ----: | :---- | :---- |
| [oto](https://github.com/hajimehoshi/oto) | 819 | ♪ A low-level library to play sound on multiple platforms ♪ | 4 months ago |
...
| [flac](https://github.com/mewkiz/flac) | 156 | Package flac provides access to FLAC (Free Lossless Audio Codec) streams. | 5 months ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [oauth2](https://github.com/golang/oauth2) | 3677 | Go OAuth2 | 2 hours ago |
| [goth](https://github.com/markbates/goth) | 3201 | Package goth provides a simple, clean, and idiomatic way to write authentication packages for Go web applications. | 2 months ago |
| [authboss](https://github.com/volatiletech/authboss) | 2681 | The boss of http auth. | a month ago |
| [loginsrv](https://github.com/tarent/loginsrv) | 1787 | JWT login microservice with plugable backends such as OAuth2, Google, Github, htpasswd, osiam, .. | 4 months ago |
| [go-jose](https://github.com/square/go-jose) | 1772 | An implementation of JOSE standards (JWE, JWS, JWT) in Go | 9 days ago |
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1765 | A standalone, specification-compliant,  OAuth2 server written in Golang. | 5 months ago |
| [osin](https://github.com/openshift/osin) | 1672 | Golang OAuth2 server library | 4 months ago |
| [gologin](https://github.com/dghubble/gologin) | 1393 | Go login handlers for authentication providers (OAuth1, OAuth2) | 5 days ago |
| [gorbac](https://github.com/mikespook/gorbac) | 1181 | goRBAC provides a lightweight role-based access control (RBAC) implementation in Golang. | a month ago |
| [scs](https://github.com/alexedwards/scs) | 885 | HTTP Session Management for Go | 9 days ago |
...
| [jwt](https://github.com/cristalhq/jwt) | 268 | Safe, simple and fast JSON Web Tokens for Go | 7 days ago |
...
| [jwt](https://github.com/pascaldekloe/jwt) | 253 | JSON Web Token library | 3 months ago |
...
| [jwt-auth](https://github.com/adam-hanna/jwt-auth) | 204 | This package provides json web token (jwt) middleware for goLang http servers | 18 days ago |
...
| [sessionup](https://github.com/swithek/sessionup) | 112 | Straightforward HTTP session management | 6 days ago |
...
| [scope](https://github.com/SonicRoshan/scope) | 12 | Easily Manage OAuth2 Scopes In Go | 21 days ago |
...
| [casbin](https://github.com/hsluoyz/casbin) | 1 | An authorization library that supports access control models like ACL, RBAC, ABAC in Golang | 17 days ago |
