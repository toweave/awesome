...
* Last Sync Time: Thu May 27 2021 11:04:17 GMT+0800 (GMT+08:00)
...
| [portaudio](https://github.com/gordonklaus/portaudio) | 450 | Go bindings for the PortAudio audio I/O library | 9 months ago |
...
| [malgo](https://github.com/gen2brain/malgo) | 148 | Mini audio library | 20 days ago |
| [mix](https://github.com/go-mix/mix) | 139 | Sequence-based Go-native audio mixer for music apps | a year ago |
| [GoAudio](https://github.com/DylanMeeus/GoAudio) | 131 | Go tools for audio processing & creation 🎶 | 2 months ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [casbin](https://github.com/casbin/casbin) | 9452 | An authorization library that supports access control models like ACL, RBAC, ABAC in Golang | 14 hours ago |
| [oauth2](https://github.com/golang/oauth2) | 3650 | Go OAuth2 | 9 days ago |
| [goth](https://github.com/markbates/goth) | 3178 | Package goth provides a simple, clean, and idiomatic way to write authentication packages for Go web applications. | a month ago |
| [authboss](https://github.com/volatiletech/authboss) | 2662 | The boss of http auth. | 9 days ago |
...
| [go-jose](https://github.com/square/go-jose) | 1765 | An implementation of JOSE standards (JWE, JWS, JWT) in Go | an hour ago |
...
| [gologin](https://github.com/dghubble/gologin) | 1388 | Go login handlers for authentication providers (OAuth1, OAuth2) | a month ago |
| [gorbac](https://github.com/mikespook/gorbac) | 1171 | goRBAC provides a lightweight role-based access control (RBAC) implementation in Golang. | 21 days ago |
...
| [scope](https://github.com/SonicRoshan/scope) | 12 | Easily Manage OAuth2 Scopes In Go | 2 days ago |
