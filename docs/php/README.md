...
* Last Sync Time: Tue Jan 11 2022 11:22:09 GMT+0800 (中国标准时间)
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [casbin](https://github.com/casbin/casbin) | 11063 | An authorization library that supports access control models like ACL, RBAC, ABAC in Golang | 3 days ago |
| [oauth2](https://github.com/golang/oauth2) | 3970 | Go OAuth2 | 15 days ago |
| [goth](https://github.com/markbates/goth) | 3472 | Package goth provides a simple, clean, and idiomatic way to write authentication packages for Go web applications. | 12 hours ago |
...
| [gologin](https://github.com/dghubble/gologin) | 1466 | Go login handlers for authentication providers (OAuth1, OAuth2) | 6 hours ago |
