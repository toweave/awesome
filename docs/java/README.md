...
| [doov](https://github.com/doov-org/doov) | 73 | dOOv (Domain Object Oriented Validation) a fluent API for type-safe bean validation and mapping | 3 months ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [bytecode-viewer](https://github.com/Konloch/bytecode-viewer) | 12971 | A Java 8+ Jar & Android APK Reverse Engineering Suite (Decompiler, Editor, Debugger & More) | 21 days ago |
| [cglib](https://github.com/cglib/cglib) | 4367 | cglib - Byte Code Generation Library is high level API to generate and transform Java byte code. It is used by AOP, testing, data access frameworks to generate dynamic proxy objects and intercept field access. | 7 days ago |
| [javassist](https://github.com/jboss-javassist/javassist) | 3522 | Java bytecode engineering toolkit | 2 days ago |
| [Mixin](https://github.com/SpongePowered/Mixin) | 885 | Mixin is a trait/mixin and bytecode weaving framework for Java using ASM | 3 months ago |
...
| [text-io](https://github.com/beryx/text-io) | 271 | A library for creating interactive console applications in Java | 2 months ago |
| [java-ascii-render](https://github.com/indvd00m/java-ascii-render) | 133 | ASCII renderer in pure java with no external dependencies | 2 years ago |
| [jbock](https://github.com/jbock-java/jbock) | 68 | Reflectionless command line parser | a month ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [javacv](https://github.com/bytedeco/javacv) | 5892 | Java interface to OpenCV, FFmpeg, and more | 21 days ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [config](https://github.com/lightbend/config) | 5605 | configuration library for JVM languages using HOCON files | 8 days ago |
| [owner](https://github.com/matteobaccan/owner) | 852 | Get rid of the boilerplate code in properties based configuration. | 22 days ago |
| [cfg4j](https://github.com/cfg4j/cfg4j) | 541 | Modern configuration library for distributed apps written in Java. | 2 years ago |
| [centraldogma](https://github.com/line/centraldogma) | 465 | Highly-available version-controlled service configuration repository based on Git, ZooKeeper and HTTP/2 | 9 days ago |
| [Configurate](https://github.com/SpongePowered/Configurate) | 232 | A simple configuration library for Java applications providing a node structure, a variety of formats, and tools for transformation | 5 days ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [jacop](https://github.com/radsz/jacop) | 189 | Java Constraint Programming solver | 5 months ago |
...
| [pcollections](https://github.com/hrldcpr/pcollections) | 691 | A Persistent Java Collections Library | a month ago |
...
| [HyperMinHash-java](https://github.com/LiveRamp/HyperMinHash-java) | 48 | Union, intersection, and set cardinality in loglog space | 4 months ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [seata](https://github.com/seata/seata) | 22148 | :fire: Seata is an easy-to-use, high-performance, open source distributed transaction solution. | 2 days ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [packr](https://github.com/libgdx/packr) | 2349 | Packages your JAR, assets and a JVM for distribution on Windows, Linux and Mac OS X | 2 months ago |
| [capsule](https://github.com/puniverse/capsule) | 1145 | Dead-Simple Packaging and Deployment for JVM Apps | 10 months ago |
| [JavaPackager](https://github.com/fvarrui/JavaPackager) | 526 | :package: Gradle/Maven plugin to package Java applications as native Windows, Mac OS X, or GNU/Linux executables and create installers for them. | 16 days ago |
| [getdown](https://github.com/threerings/getdown) | 454 | Download, Install, Update | 2 months ago |
| [artipie](https://github.com/artipie/artipie) | 256 | Binary Artifact Management Tool | 7 days ago |
| [really-executable-jars-maven-plugin](https://github.com/brianm/really-executable-jars-maven-plugin) | 110 | maven plugin for making chmod +x jar files | 6 months ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [fastexcel](https://github.com/dhatim/fastexcel) | 379 | Generate and read big Excel files quickly | 25 days ago |
| [zerocell](https://github.com/creditdatamw/zerocell) | 65 | Simple, efficient Excel to POJO library for Java  | 4 months ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [jOOL](https://github.com/jOOQ/jOOL) | 1918 | jOOλ - The Missing Parts in Java 8 jOOλ improves the JDK libraries in areas where the Expert Group's focus was elsewhere. It adds tuple support, function support, and a lot of additional functionality around sequential Streams. The JDK 8's main efforts (default methods, lambdas, and the Stream API) were focused around maintaining backwards compatibility and implementing a functional API for parallelism. | a year ago |
| [streamex](https://github.com/amaembo/streamex) | 1854 | Enhancing Java Stream API | 3 months ago |
| [cyclops](https://github.com/aol/cyclops) | 1225 | An advanced, but easy to use, platform for writing functional applications in Java 8. | a day ago |
| [derive4j](https://github.com/derive4j/derive4j) | 538 | Java 8 annotation processor and framework for deriving algebraic data types constructors, pattern-matching, folds, optics and typeclasses. | 9 months ago |
| [protonpack](https://github.com/poetix/protonpack) | 458 | Stream utilities for Java 8 | 5 months ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [JCTools](https://github.com/JCTools/JCTools) | 2928 |  | 2 months ago |
| [agrona](https://github.com/real-logic/agrona) | 2275 | High Performance data structures and utility methods for Java | 3 days ago |
| [eclipse-collections](https://github.com/eclipse/eclipse-collections) | 1939 | Eclipse Collections is a collections framework for Java with optimized data structures and a rich, functional and fluent API. | a day ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [feign](https://github.com/OpenFeign/feign) | 8052 | Feign makes writing java http clients easier | 8 days ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [zxing](https://github.com/zxing/zxing) | 29550 | ZXing ("Zebra Crossing") barcode scanning library for Java, Android | 4 days ago |
| [thumbnailator](https://github.com/coobird/thumbnailator) | 4145 | Thumbnailator - a thumbnail generation library for Java | 2 months ago |
| [TwelveMonkeys](https://github.com/haraldk/TwelveMonkeys) | 1441 | TwelveMonkeys ImageIO: Additional plug-ins and extensions for Java's ImageIO | a day ago |
| [tess4j](https://github.com/nguyenq/tess4j) | 1159 | Java JNA wrapper for Tesseract OCR API | 23 days ago |
| [imgscalr](https://github.com/rkalla/imgscalr) | 1112 | Simple Java image-scaling library implementing Chris Campbell's incremental scaling algorithm as well as Java2D's "best-practices" image-scaling techniques. | 9 months ago |
| [image-comparison](https://github.com/romankh3/image-comparison) | 209 | Published on Maven Central Java Library that compares 2 images with the same sizes and shows the differences visually by drawing rectangles. Some parts of the image can be excluded from the comparison. Can be used for automation QA tests. | a month ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [reflections](https://github.com/ronmamo/reflections) | 4131 | Java runtime metadata analysis | 4 days ago |
| [jOOR](https://github.com/jOOQ/jOOR) | 2583 |  jOOR - Fluent Reflection in Java jOOR is a very simple fluent API that gives access to your Java Class structures in a more intuitive way. The JDK's reflection APIs are hard and verbose to use. Other languages have much simpler constructs to access type meta information at runtime. Let us make Java reflection better. | 2 months ago |
| [classgraph](https://github.com/classgraph/classgraph) | 2221 | An uber-fast parallelized Java classpath scanner and module scanner. | 2 days ago |
| [reflectasm](https://github.com/EsotericSoftware/reflectasm) | 1324 | High performance Java reflection | 3 months ago |
...
| [jackson-modules-java8](https://github.com/FasterXML/jackson-modules-java8) | 349 | Set of support modules for Java 8 datatypes (Optionals, date/time) and features (parameter names) | 5 days ago |
| [json-io](https://github.com/jdereg/json-io) | 296 | Convert Java to JSON. Convert JSON to Java.  Pretty print JSON.  Java JSON serializer. | 2 months ago |
| [JsonSurfer](https://github.com/wanglingsong/JsonSurfer) | 240 | A streaming JsonPath processor in Java | 2 months ago |
| [jackson-datatype-money](https://github.com/zalando/jackson-datatype-money) | 199 | Extension module to properly support datatypes of javax.money | 2 days ago |
| [yasson](https://github.com/eclipse-ee4j/yasson) | 178 | Eclipse Yasson project | 10 days ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [p6spy](https://github.com/p6spy/p6spy) | 1655 | P6Spy is a framework that enables database data to be seamlessly intercepted and logged with no code changes to the application. | 3 months ago |
| [logbook](https://github.com/zalando/logbook) | 1099 | An extensible Java library for HTTP request and response logging | 3 days ago |
| [opentracing-toolbox](https://github.com/zalando/opentracing-toolbox) | 179 | Best-of-breed OpenTracing utilities, instrumentations and extensions | 8 days ago |
...
| [cqengine](https://github.com/npgall/cqengine) | 1494 | Ultra-fast SQL-like queries on Java collections | 8 months ago |
| [jsweet](https://github.com/cincheo/jsweet) | 1293 | A Java to JavaScript transpiler. | 8 months ago |
| [jbot](https://github.com/rampatra/jbot) | 1173 | Make Slack and Facebook Bots in Java. | 2 months ago |
| [ff4j](https://github.com/ff4j/ff4j) | 1060 | Feature Flags for Java made easy | a day ago |
...
| [yGuard](https://github.com/yWorks/yGuard) | 216 | The open-source Java obfuscation tool working with Ant and Gradle by yWorks - the diagramming experts | a month ago |
| [MinimalFTP](https://github.com/Guichaguri/MinimalFTP) | 120 | A lightweight, simple FTP server. Pure Java, no dependencies. | 2 years ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [jna](https://github.com/java-native-access/jna) | 7129 | Java Native Access | 3 days ago |
| [javacpp](https://github.com/bytedeco/javacpp) | 3826 | The missing bridge between Java and native C++ | a month ago |
| [jnr-ffi](https://github.com/jnr/jnr-ffi) | 985 | Java Abstracted Foreign Function Layer | a month ago |
| [aparapi](https://github.com/Syncleus/aparapi) | 408 | The New Official Aparapi: a framework for executing native Java and Scala code on the GPU. | 15 days ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [cogcomp-nlp](https://github.com/CogComp/cogcomp-nlp) | 444 | CogComp's Natural Language Processing Libraries and Demos: Modules include lemmatizer, ner, pos, prep-srl, quantifier, question type, relation-extraction, similarity, temporal normalizer, tokenizer, transliteration, verb-sense, and more. | 3 months ago |
...
| [dynamicreports](https://github.com/dynamicreports/dynamicreports) | 155 | Java reporting library for creating dynamic report designs at runtime | a year ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [jitwatch](https://github.com/AdoptOpenJDK/jitwatch) | 2639 | Log analyser / visualiser for Java HotSpot JIT compiler. Inspect inlining decisions, hot methods, bytecode, and assembly. View results in the JavaFX user interface. | 16 days ago |
| [honest-profiler](https://github.com/jvm-profiling-tools/honest-profiler) | 1191 | A sampling JVM profiler without the safepoint sample bias | 3 months ago |
...
| [LatencyUtils](https://github.com/LatencyUtils/LatencyUtils) | 433 | Utilities for latency measurement and reporting | 8 months ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [tablesaw](https://github.com/jtablesaw/tablesaw) | 2913 | Java dataframe and visualization library | 18 days ago |
| [jgrapht](https://github.com/jgrapht/jgrapht) | 2111 | Master repository for the JGraphT project | 2 months ago |
| [XChart](https://github.com/knowm/XChart) | 1279 | XChart is a light-weight Java library for plotting data. | 4 days ago |
| [jgraphx](https://github.com/jgraph/jgraphx) | 632 |  | 2 years ago |
| [chart-fx](https://github.com/fair-acc/chart-fx) | 342 | A scientific charting library focused on performance optimised real-time data visualisation at 25 Hz update rates for data sets with a few 10 thousand up to 5 million data points. | 2 days ago |
...
| [orson-charts](https://github.com/jfree/orson-charts) | 90 | A 3D chart library for Java applications (JavaFX, Swing or server-side). | 4 months ago |
| [LogicNG](https://github.com/logic-ng/LogicNG) | 89 | The Next Generation Logic Library | 4 days ago |
...
| [password4j](https://github.com/Password4j/password4j) | 190 | Password4j is a user-friendly cryptographic library that supports Argon2, Bcrypt, Scrypt, PBKDF2 and various cryptographic hash functions. | a month ago |
| [jwks-rsa-java](https://github.com/auth0/jwks-rsa-java) | 141 |  | 2 months ago |
| [otp-java](https://github.com/BastiaanJansen/otp-java) | 68 | A small and easy-to-use one-time password generator library for Java according to RFC 4226 (HOTP) and RFC 6238 (TOTP). | 8 days ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [flatbuffers](https://github.com/google/flatbuffers) | 17902 | FlatBuffers: Memory Efficient Serialization Library | a day ago |
| [kryo](https://github.com/EsotericSoftware/kryo) | 5414 | Java binary serialization and cloning: fast, efficient, automatic | 21 days ago |
| [fast-serialization](https://github.com/RuedigerMoeller/fast-serialization) | 1454 | FST: fast java serialization drop in-replacement  | 16 days ago |
| [msgpack-java](https://github.com/msgpack/msgpack-java) | 1279 | MessagePack serializer implementation for Java / msgpack.org[Java] | 5 days ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [nanohttpd](https://github.com/NanoHttpd/nanohttpd) | 6315 | Tiny, easily embeddable HTTP server in Java. | 19 days ago |
...
| [hoverfly-java](https://github.com/SpectoLabs/hoverfly-java) | 142 | Java binding for Hoverfly | 2 months ago |
...
| [beanmother](https://github.com/keepcosmos/beanmother) | 111 | A library for setting up Java objects as test data. | a year ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [xmlunit](https://github.com/xmlunit/xmlunit) | 264 | XMLUnit for Java 2.x | 2 months ago |
...
| [bucket4j](https://github.com/vladimir-bukhtoyarov/bucket4j) | 1468 | Java rate limiting library based on token-bucket algorithm. | 17 days ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [sdkman-cli](https://github.com/sdkman/sdkman-cli) | 4656 | The SDKMAN! Command Line Interface | 23 days ago |
| [jenv](https://github.com/jenv/jenv) | 4244 | Manage your Java environment  | 9 days ago |
| [jabba](https://github.com/shyiko/jabba) | 2328 | (cross-platform) Java Version Manager | a month ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [webmagic](https://github.com/code4craft/webmagic) | 10380 | A scalable web crawler framework for Java. | 17 days ago |
| [crawler4j](https://github.com/yasserg/crawler4j) | 4273 | Open Source Web Crawler for Java | 7 months ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [blade](https://github.com/lets-blade/blade) | 5613 | :rocket: Lightning fast and elegant mvc framework for Java8 | 10 days ago |
| [takes](https://github.com/yegor256/takes) | 719 | True Object-Oriented Java Web Framework | 22 days ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [awesome-microservices](https://github.com/mfornos/awesome-microservices) | 11022 | A curated list of Microservice Architecture related principles and technologies. | 2 days ago |
| [useful-java-links](https://github.com/Vedenin/useful-java-links) | 5218 | A list of useful Java frameworks, libraries, software and hello worlds examples | a month ago |
| [awesome-rest](https://github.com/marmelab/awesome-rest) | 3041 | A collaborative list of great resources about RESTful API architecture, development, test, and performance | 2 days ago |
| [java-developer-roadmap](https://github.com/s4kibs4mi/java-developer-roadmap) | 2683 | Roadmap to becoming a Java developer in 2021 | 4 months ago |
| [AwesomeJavaFX](https://github.com/mhrimaz/AwesomeJavaFX) | 2604 | A curated list of awesome JavaFX libraries, books, frameworks, etc... | a month ago |
| [awesome-jvm](https://github.com/deephacks/awesome-jvm) | 1768 | A curated list of awesome loosely performance related JVM stuff. Inspired by awesome-python. | 2 years ago |
| [awesome-ciandcd](https://github.com/cicdops/awesome-ciandcd) | 1438 | continuous integration and continuous delivery | 10 days ago |
| [java-concurrency](https://github.com/code-review-checklists/java-concurrency) | 1033 | Checklist for code reviews | 2 years ago |
| [awesome-selenium](https://github.com/christian-bromann/awesome-selenium) | 787 | A curated list of delightful Selenium resources. | 2 months ago |
...
| [awesome-annotation-processing](https://github.com/gunnarmorling/awesome-annotation-processing) | 299 | A curated list of resources related to the Java annotation processing API (JSR 269) | 3 months ago |
