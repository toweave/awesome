...
* Last Sync Time: Fri Jun 04 2021 10:13:40 GMT+0800 (GMT+08:00)
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [oauth2](https://github.com/golang/oauth2) | 3660 | Go OAuth2 | 17 days ago |
| [goth](https://github.com/markbates/goth) | 3185 | Package goth provides a simple, clean, and idiomatic way to write authentication packages for Go web applications. | 2 months ago |
| [authboss](https://github.com/volatiletech/authboss) | 2668 | The boss of http auth. | 17 days ago |
| [loginsrv](https://github.com/tarent/loginsrv) | 1783 | JWT login microservice with plugable backends such as OAuth2, Google, Github, htpasswd, osiam, .. | 3 months ago |
| [go-jose](https://github.com/square/go-jose) | 1768 | An implementation of JOSE standards (JWE, JWS, JWT) in Go | 6 days ago |
| [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) | 1754 | A standalone, specification-compliant,  OAuth2 server written in Golang. | 5 months ago |
...
| [scs](https://github.com/alexedwards/scs) | 882 | HTTP Session Management for Go | 2 months ago |
...
| [go-guardian](https://github.com/shaj13/go-guardian) | 259 | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication. | a month ago |
...
| [jwt-auth](https://github.com/adam-hanna/jwt-auth) | 204 | This package provides json web token (jwt) middleware for goLang http servers | 7 days ago |
...
| [scope](https://github.com/SonicRoshan/scope) | 12 | Easily Manage OAuth2 Scopes In Go | 10 days ago |
...
| [casbin](https://github.com/hsluoyz/casbin) | 1 | An authorization library that supports access control models like ACL, RBAC, ABAC in Golang | 6 days ago |
