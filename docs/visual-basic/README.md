...
* Last Sync Time: Mon Nov 08 2021 09:17:12 GMT+0800 (中国标准时间)
...
| :---- | ----: | :---- | :---- |
| [oto](https://github.com/hajimehoshi/oto) | 881 | ♪ A low-level library to play sound on multiple platforms ♪ | a day ago |
...
| [GoAudio](https://github.com/DylanMeeus/GoAudio) | 160 | Go tools for audio processing & creation 🎶 | a day ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [casbin](https://github.com/casbin/casbin) | 10610 | An authorization library that supports access control models like ACL, RBAC, ABAC in Golang | 5 days ago |
...
| [go-jose](https://github.com/square/go-jose) | 1831 | An implementation of JOSE standards (JWE, JWS, JWT) in Go | 13 days ago |
...
| [gologin](https://github.com/dghubble/gologin) | 1450 | Go login handlers for authentication providers (OAuth1, OAuth2) | 40 minutes ago |
...
| [jwt](https://github.com/cristalhq/jwt) | 301 | Safe, simple and fast JSON Web Tokens for Go | 20 days ago |
