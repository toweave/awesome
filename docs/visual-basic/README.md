...
* Last Sync Time: Mon Dec 13 2021 10:08:12 GMT+0800 (中国标准时间)
...
| :---- | ----: | :---- | :---- |
| [oto](https://github.com/hajimehoshi/oto) | 911 | ♪ A low-level library to play sound on multiple platforms ♪ | a month ago |
...
| [flac](https://github.com/mewkiz/flac) | 182 | Package flac provides access to FLAC (Free Lossless Audio Codec) streams. | 10 months ago |
...
| Repository | StarCount | Description | RecentlyUpdated |
| :---- | ----: | :---- | :---- |
| [casbin](https://github.com/casbin/casbin) | 10822 | An authorization library that supports access control models like ACL, RBAC, ABAC in Golang | 2 days ago |
| [oauth2](https://github.com/golang/oauth2) | 3931 | Go OAuth2 | 12 hours ago |
| [goth](https://github.com/markbates/goth) | 3442 | Package goth provides a simple, clean, and idiomatic way to write authentication packages for Go web applications. | 17 days ago |
| [authboss](https://github.com/volatiletech/authboss) | 2944 | The boss of http auth. | 4 months ago |
...
| [loginsrv](https://github.com/tarent/loginsrv) | 1834 | JWT login microservice with plugable backends such as OAuth2, Google, Github, htpasswd, osiam, .. | 10 months ago |
| [osin](https://github.com/openshift/osin) | 1708 | Golang OAuth2 server library | 24 days ago |
| [gologin](https://github.com/dghubble/gologin) | 1460 | Go login handlers for authentication providers (OAuth1, OAuth2) | 3 days ago |
...
| [scs](https://github.com/alexedwards/scs) | 981 | HTTP Session Management for Go | 6 days ago |
...
| [jwt](https://github.com/cristalhq/jwt) | 306 | Safe, simple and fast JSON Web Tokens for Go | a day ago |
